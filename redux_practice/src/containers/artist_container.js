...
import { artistsDetail, clearArtistsDetail} from '../actions'
...
class ArtistContainer extends Component {
    ...
    componentWillMount() {
       this.props.artistsDetail(this.props.match.params.id)

    }
    
    componentWillUnmount(){
     this.props.clearArtistsDetail()
    }
    ...
    render(){
        return (
        <div>
            {this.artistTemplate(this.props.artists)}</div>
        );
    }
}
